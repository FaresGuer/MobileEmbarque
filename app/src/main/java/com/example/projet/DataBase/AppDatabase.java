...
@Database(entities = {User.class, EmergencyContact.class, Friend.class, HeartRateLog.class, EnvironmentAlert.class,FallEvent.class, AlertHistory.class}, version = 5)
