...
public final class UserDao_Impl implements UserDao {
  ...
  public UserDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfUser = new EntityInsertionAdapter<User>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `users` (`id`,`username`,`email`,`phoneNumber`,`dateOfBirth`,`avatarPath`,`password`) VALUES (nullif(?, 0),?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement, final User entity) {
        ...
        if (entity.getAvatarPath() == null) {
          ...
          statement.bindString(6, entity.getAvatarPath());
        }
    ...
    this.__updateAdapterOfUser = new EntityDeletionOrUpdateAdapter<User>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `users` SET `id` = ?,`username` = ?,`email` = ?,`phoneNumber` = ?,`dateOfBirth` = ?,`avatarPath` = ?,`password` = ? WHERE `id` = ?";
      }
  ...
  @Override
  public User login(final String username, final String passwordHash) {
    ...
    try {
      ...
      if (_cursor.moveToFirst()) {
        ...
        _result.setAvatarPath(_tmpAvatarPath);
